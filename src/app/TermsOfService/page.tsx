import '@/app/TermsOfService/TermsOfService.scss';
  ...
  return (
    <div className="TermsOfService">
      ...
      <p>
        ...
        of Tommy Grabowski&apos;s Website, located at
        http://www.tommygrabowski.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Tommy Grabowski if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Tommy Grabowski, you agreed
        to use cookies in agreement with the Tommy Grabowski&apos;s Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Tommy Grabowski and/or its licensors own the
        intellectual property rights for all material on Tommy Grabowski. All
        intellectual property rights are reserved. You may access this from
        Tommy Grabowski for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Tommy Grabowski</li>
        <li>Sell, rent or sub-license material from Tommy Grabowski</li>
        <li>Reproduce, duplicate or copy material from Tommy Grabowski</li>
        <li>Redistribute content from Tommy Grabowski</li>
      </ul>
      <p>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Tommy
        Grabowski does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Tommy Grabowski,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Tommy Grabowski
      ...
      <p>
        Tommy Grabowski reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Tommy Grabowski a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Tommy Grabowski; and (d) the
      ...
      <p>
        ...
        e-mail to Tommy Grabowski. Please include your name, your organization
      ...
      <p>
        No use of Tommy Grabowski&apos;s logo or other artwork will be allowed
      ...
      <p>
        Please read our{' '}
        <Link href={`https://www.tommygrabowski.com/PrivacyPolicy`}>
          Privacy Policy
        </Link>
      </p>
      <h3>
...
function TermsOfServiceHeader() {
  return (
    <div>
      <h2 className="pb-4 text-lg font-bold">Terms of Service</h2>
    </div>
  );
}
